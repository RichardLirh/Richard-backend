...
import richard.common.utils.AESUtils;
import richard.common.utils.HashEncryptionUtil;
import richard.common.utils.JsonUtils;
import richard.modules.agent.Enums.RichardMcpJsonRpcJson;
    ...
    public List<String> getAgentMcpToolsList(String id) {
        ...
        try {
            ...
            try (WebSocketClientManager client = WebSocketClientManager.build(
                ...
                client.sendText(RichardMcpJsonRpcJson.getInitializeJson());
                ...
                client.sendText(RichardMcpJsonRpcJson.getNotificationsInitializedJson());
                // 步骤3: 发送工具列表请求 - 立即发送，无需额外延迟
                log.info("发送MCP工具列表请求，智能体ID: {}", id);
                client.sendText(RichardMcpJsonRpcJson.getToolsListJson());
