package richard.modules.config.service.impl;
...
import richard.modules.agent.dao.AgentVoicePrintDao;
...
import richard.modules.agent.entity.AgentVoicePrintEntity;
import richard.modules.agent.service.AgentContextProviderService;
import richard.modules.agent.service.AgentMcpAccessPointService;
...
import richard.modules.agent.vo.AgentVoicePrintVO;
...
import richard.modules.sys.dto.SysParamsDTO;
import richard.modules.sys.service.SysParamsService;
import richard.modules.timbre.service.TimbreService;
import richard.modules.timbre.vo.TimbreDetailsVO;
import richard.modules.voiceclone.entity.VoiceCloneEntity;
import richard.modules.voiceclone.service.VoiceCloneService;
...
public class ConfigServiceImpl implements ConfigService {
    ...
    private void buildModuleConfig(
        ...
        if (StringUtils.isNotBlank(prompt)) {
            prompt = prompt.replace("{{assistant_name}}", StringUtils.isBlank(assistantName) ? "richard" : assistantName);
        }
