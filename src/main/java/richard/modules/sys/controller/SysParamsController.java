package richard.modules.sys.controller;
...
import richard.common.annotation.LogOperation;
...
import richard.common.validator.group.AddGroup;
import richard.common.validator.group.DefaultGroup;
import richard.common.validator.group.UpdateGroup;
...
import richard.modules.sys.utils.WebSocketValidator;
...
public class SysParamsController {
    ...
    private void validateMqttSecretLength(String paramCode, String secret) {
        ...
        // 不允许包含弱密码
        String[] weakPasswords = { "test", "1234", "admin", "password", "qwerty", "richard" };
