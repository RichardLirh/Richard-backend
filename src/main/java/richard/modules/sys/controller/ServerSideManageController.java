...
import richard.modules.sys.dto.EmitSeverActionDTO;
import richard.modules.sys.dto.ServerActionPayloadDTO;
import richard.modules.sys.dto.ServerActionResponseDTO;
import richard.modules.sys.enums.ServerActionEnum;
import richard.modules.sys.service.SysParamsService;
import richard.modules.sys.utils.WebSocketClientManager;
...
public class ServerSideManageController {
    ...
    private Boolean emitServerActionByWs(String targetWsUri, ServerActionEnum actionEnum) {
        ...
        String redisKey = richard.common.redis.RedisKeys.getTmpRegisterMacKey(deviceId);
