package richard.modules.device.service.impl;
...
import richard.common.utils.DateUtils;
import richard.common.utils.ToolUtil;
import richard.modules.device.dao.DeviceDao;
import richard.modules.device.dto.DeviceManualAddDTO;
import richard.modules.device.dto.DevicePageUserDTO;
import richard.modules.device.dto.DeviceReportReqDTO;
import richard.modules.device.dto.DeviceReportRespDTO;
...
import richard.modules.device.service.OtaService;
import richard.modules.device.vo.UserShowDeviceListVO;
...
public class DeviceServiceImpl extends BaseServiceImpl<DeviceDao, DeviceEntity> implements DeviceService {
    ...
    public DeviceReportRespDTO checkDeviceActive(String macAddress, String clientId, DeviceReportReqDTO deviceReport) {
        ...
        if (StringUtils.isBlank(wsUrl) || wsUrl.equals("null")) {
            ...
            wsUrl = "ws://richard.server.com:8000/richard/v1/";
            ...
            if (wsUrls.length > 0) {
                ...
                log.error("WebSocket地址未配置，请登录智控台，在参数管理找到【server.websocket】配置");
                websocket.setUrl("ws://richard.server.com:8000/richard/v1/");
            }
        }
