...
import richard.common.utils.ResourcesUtils;
...
public class RedisUtils {
    ...
    public Object get(String key, long expire) {
        ...
        try {
            ...
            // Old cached payloads may reference removed/renamed classes.
            log.warn("Redis deserialization failed for key: {}, deleting stale cache. cause: {}", key, ex.getMessage());
